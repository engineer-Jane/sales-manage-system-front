...
import { RECORDS_MODE, RECORDS_TYPE } from '@/constants';
...
const TableList: React.FC = () => {
  ...
  const onJump = (id?: string) => {
    history.push(`/bills/records/add?id=${id}`)
  }
  ...
  return (
    <PageContainer>
      <ProTable<API.TableItem, API.Params>
        ...
        toolBarRender={() => [
          <Button key="" onClick={() => downloadExcel('POST', EXPORT_URL.PREPAYMENT_RECORD, {})}>
            <DownloadOutlined />
            导出明细
          </Button>,
          <Receipt />
